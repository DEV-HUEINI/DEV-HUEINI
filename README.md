...
<div style="background-image: url('https://github.com/Hueini/images/blob/main/HD-CIRCLE.png?raw=true'); background-repeat: no-repeat; background-attachment: fixed; padding:  40px; overflow: hidden;">
